# Cortexbias: An Economic Framework

![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)
![Status: Active](https://img.shields.io/badge/Status-Active-blue.svg)
![Category: Neuroeconomics](https://img.shields.io/badge/Category-cortexbias-purple.svg)

## Overview
`Cortexbias` is modeled as neural architecture imbalance in economic decision making. The repository defines one canonical concept expression and one executable index pipeline. The mechanism focus is choice distortion when reactive channels dominate deliberative control.
...
## Citation
Economic Research Collective (2026). "Cortexbias: An Economic Framework."
